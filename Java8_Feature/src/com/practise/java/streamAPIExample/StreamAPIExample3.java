...
public class StreamAPIExample3 {
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println("1. Integer Stream"); 
				...
				Stream<String> bands = Files.lines(Paths.get("C:\\Workspaces\\Java_Concept_Practise\\Java8_Feature\\src\\resource\\bands.txt"));
				bands
					.sorted()
				...
				List<String> bands2 = Files.lines(Paths.get("C:\\Workspaces\\Java_Concept_Practise\\Java8_Feature\\src\\resource\\bands.txt"))
					.filter(x -> x.contains("jit"))
					.collect(Collectors.toList());
				bands2.forEach(x -> System.out.println(x));
				
				System.out.println("10. Stream rows from CSV file and count");
				Stream<String> rows1 = Files.lines(Paths.get("C:\\Workspaces\\Java_Concept_Practise\\Java8_Feature\\src\\resource\\data.txt"));
				...
				Stream<String> rows2 = Files.lines(Paths.get("C:\\Workspaces\\Java_Concept_Practise\\Java8_Feature\\src\\resource\\data.txt"));
				rows2
					.map(x -> x.split(","))
		            .filter(x -> x.length == 3)
				...
				Stream<String> rows3 = Files.lines(Paths.get("C:\\Workspaces\\Java_Concept_Practise\\Java8_Feature\\src\\resource\\data.txt"));
